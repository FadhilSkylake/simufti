    ...
    <div class="login-box">
        ...
        <div class="card card-outline card-primary">
            <div class="card-header text-center">
                <img src="<?= base_url(); ?>/img/almufti.png" alt="logo" width="200" height="200">
                <h4>Sistem Informasi Akademik</h4>
                <h4><b>SMK AL-MUFTI</b></h4>
            </div>
            <div class="card-body">
                ...
                <form action="/login" method="post">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" class="form-control " required name="login" placeholder="Username">
